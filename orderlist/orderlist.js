...
this.primevue.orderlist = (function (Button, utils, Ripple, vue) {
    'use strict';
    ...
    var script = {
        ...
        methods: {
            ...
            onItemClick(event, item, index) {
                ...
                let selectedIndex = utils.ObjectUtils.findIndexInList(item, this.d_selection);
            ...
            findNextItem(item) {
                ...
                if (nextItem)
                    return !utils.DomHandler.hasClass(nextItem, 'p-orderlist-item') ? this.findNextItem(nextItem) : nextItem;
                else
                    return null;
            },
            findPrevItem(item) {
                ...
                if (prevItem)
                    return !utils.DomHandler.hasClass(prevItem, 'p-orderlist-item') ? this.findPrevItem(prevItem) : prevItem;
                else
                    return null;
            },
            updateListScroll() {
                const listItems = utils.DomHandler.find(this.$refs.list.$el, '.p-orderlist-item.p-highlight');
