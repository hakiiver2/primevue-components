...
this.primevue=this.primevue||{},this.primevue.useconfirm=function(e,i){"use strict";const r=Symbol();return e.PrimeVueConfirmSymbol=r,e.useConfirm=function(){const e=i.inject(r);if(!e)throw new Error("No PrimeVue Confirmation provided!");return e},e}({},Vue);

this.primevue=this.primevue||{},this.primevue.usetoast=function(e,t){"use strict";const r=Symbol();return e.PrimeVueToastSymbol=r,e.useToast=function(){const e=t.inject(r);if(!e)throw new Error("No PrimeVue Toast provided!");return e},e}({},Vue);

this.primevue=this.primevue||{},this.primevue.usedialog=function(e,i){"use strict";const r=Symbol();return e.PrimeVueDialogSymbol=r,e.useDialog=function(){const e=i.inject(r);if(!e)throw new Error("No PrimeVue Dialog provided!");return e},e}({},Vue);

this.primevue=this.primevue||{},this.primevue.button=function(t,e){"use strict";var i={name:"Button",props:{label:{type:String},icon:{type:String},iconPos:{type:String,default:"left"},badge:{type:String},badgeClass:{type:String,default:null},loading:{type:Boolean,default:!1},loadingIcon:{type:String,default:"pi pi-spinner pi-spin"}},computed:{buttonClass(){return{"p-button p-component":!0,"p-button-icon-only":this.icon&&!this.label,"p-button-vertical":("top"===this.iconPos||"bottom"===this.iconPos)&&this.label,"p-disabled":this.$attrs.disabled||this.loading,"p-button-loading":this.loading,"p-button-loading-label-only":this.loading&&!this.icon&&this.label}},iconClass(){return[this.loading?"p-button-loading-icon "+this.loadingIcon:this.icon,"p-button-icon",{"p-button-icon-left":"left"===this.iconPos&&this.label,"p-button-icon-right":"right"===this.iconPos&&this.label,"p-button-icon-top":"top"===this.iconPos&&this.label,"p-button-icon-bottom":"bottom"===this.iconPos&&this.label}]},badgeStyleClass(){return["p-badge p-component",this.badgeClass,{"p-badge-no-gutter":this.badge&&1===String(this.badge).length}]},disabled(){return this.$attrs.disabled||this.loading},defaultAriaLabel(){return this.label?this.label+(this.badge?" "+this.badge:""):this.$attrs["aria-label"]}},directives:{ripple:t}};const l=["aria-label","disabled"],n={class:"p-button-label"};return i.render=function(t,i,o,a,s,r){const b=e.resolveDirective("ripple");return e.withDirectives((e.openBlock(),e.createElementBlock("button",{class:e.normalizeClass(r.buttonClass),type:"button","aria-label":r.defaultAriaLabel,disabled:r.disabled},[e.renderSlot(t.$slots,"default",{},(()=>[o.loading&&!o.icon?(e.openBlock(),e.createElementBlock("span",{key:0,class:e.normalizeClass(r.iconClass)},null,2)):e.createCommentVNode("",!0),o.icon?(e.openBlock(),e.createElementBlock("span",{key:1,class:e.normalizeClass(r.iconClass)},null,2)):e.createCommentVNode("",!0),e.createElementVNode("span",n,e.toDisplayString(o.label||" "),1),o.badge?(e.openBlock(),e.createElementBlock("span",{key:2,class:e.normalizeClass(r.badgeStyleClass)},e.toDisplayString(o.badge),3)):e.createCommentVNode("",!0)]))],10,l)),[[b]])},i}(primevue.ripple,Vue);
